...
return (
        <div className={`bg-white flex flex-col rounded-[2rem] border-2 border-[#E3E3E3] text-center justify-evenly px-[1.6rem] ${typeStyle === "primary" ? "max-w-[36.2rem]" : "min-h-[30.8rem] max-w-[27.3rem]"}`}>
