...
export function Button({ titleBt, icon: Icon, typeStyle = "primary", ...rest }: ButtonProps) {
    ...
    return (
        ...
        >
            ...
            <span className={`font-medium text-[1.6rem] ${typeStyle === "primary" ? "text-white" : "text-custom-salmon"} `}>{titleBt}</span>
        </button>
    )
}
