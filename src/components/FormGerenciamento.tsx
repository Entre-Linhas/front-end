...
interface FormGerenciamentolProps extends HTMLAttributes<HTMLDivElement> {
    childrenForm: React.ReactNode;
    _showForm: boolean
    _closeForm: () => void;
}

export const FormGerenciamento = ({ childrenForm, _showForm, _closeForm, ...rest}: FormGerenciamentolProps) => {
    return (
