    ...
    <>  
        ...
        <div className="m-auto">
            ...
            <div className="flex flex-col gap-2 m-auto">
                <Input className="min-[220px]: w-full min-[720px]:max-w-[80%]" placeholder="Seu nome" onChange={(e: any) => setEmail(e.target.value)} leftElement={<UserCircle className="mr-2 text-zinc-300" weight="light" size={31} />}/>
                ...
                <Input className="min-[220px]: h-[23.1rem] w-full min-[720px]:max-w-[80%]" placeholder="Como podemos te ajudar?" onChange={(e: any) => setEmail(e.target.value)} leftElement={<ChatText className="mr-2 text-zinc-300" weight="light" size={31} />}/>
                <button className="bg-[#1E1E1E]] text-white py-[1.5rem] px-[17.8rem]">Enviar</button>
            </div>
        </div>
