...
export default function Home({NameUser, PhotoUser, TextUser}: HomeProps) {
  ...
  <div>
      <Header />
        ...
        <div className="person bg-[#62B8AF] h-[60vh] flex"> 
        <div className="items-center flex box-border w-[100%] px-[1.5rem] mx-auto sm:max-w-[100%] md:max-w-[100%] lg:max-w-[97.6rem] xl:max-w-[122rem] 2xl:max-w-[147.6rem]">
                <div className="flex flex-col gap-[1.6rem] text-white m-auto max-w-[40%]">
      ...
      <div>
        <div className="flex justify-center box-border w-[100%] h-[23.1rem] mx-auto -mt-11 xl:max-w-[1220px] 2xl:max-w-[1476px]">
      ...
      <div className="py-[80px] box-border w-[100%] m-auto px-[1.5rem] sm:max-w-[] md:max-w-[] lg:max-w-[] xl:max-w-[1220px] 2xl:max-w-[1476px]">
      ...
      <div className="py-[10rem] flex box-border w-[100%] px-[1.5rem] mx-auto sm:max-w-[] md:max-w-[] lg:max-w-[] xl:max-w-[1220px] 2xl:max-w-[1476px]">
        ...
        <div className="h-[50.9rem] py-[25rem]">
          <div className="flex flex-col items-center justify-center text-center box-border h-[90%] w-[100%] px-[1.5rem] mx-auto sm:max-w-[] md:max-w-[] lg:max-w-[] xl:max-w-[1220px] 2xl:max-w-[1476px]">
                <div className="flex">  
        ...
        <div className="box-border w-[100%] px-[1.5rem] py-[10.2rem] mx-auto sm:max-w-[] md:max-w-[] lg:max-w-[] xl:max-w-[1220px] 2xl:max-w-[1476px]">
      ...
      <div className="py-[30px] items-center  flex box-border w-[100%] px-[1.5rem] mx-auto sm:max-w-[] md:max-w-[] lg:max-w-[] xl:max-w-[1220px] 2xl:max-w-[1476px]">
          <img src="/cellphone.svg" className="max-[640px]:hidden"></img>
