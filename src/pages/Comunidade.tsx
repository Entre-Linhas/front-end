...
<div className="flex items-center py-[11rem] justify-center max-[1023px]:flex-col">
    ...
    <div className="flex flex-col gap-[5rem] px-[5rem]">
        <h1 className="text-center font-semibold m-auto text-[2.8rem] min-[425px]:text-[3rem] min-[1024px]:text-[4.8rem]">Conheça o fórum  
do <br/><span className="text-custom-salmon font-[Sacramento]"> Entre-Linhas</span></h1>
        ...
        <button className="bg-[#62B8AF] px-[6rem] py-[1.5rem] text-white text-[1.8rem] rounded-[1rem]">Clique aqui</button>
    </div>
