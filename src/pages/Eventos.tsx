        ...
        <>
            ...
            <div className="flex items-center py-[10rem] justify-center max-[1023px]:flex-col ">
                ...
                <div className="flex flex-col gap-[5rem] px-[5rem] max-[360px]:px-[1rem] ">
                    <h1 className="font-semibold text-[2.8rem] min-[425px]:text-[3rem] min-[1024px]:text-[4.8rem] dark:text-white">Eventos do <span className="text-custom-salmon">Entre-Linhas</span></h1>
