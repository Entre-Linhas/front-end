        ...
        <>
            ...
            <div className="flex items-center py-[11rem] justify-center max-[1023px]:flex-col ">
                ...
                <div className="flex flex-col gap-[5rem] px-[5rem]">
                    <h1 className="text-center font-semibold m-auto text-[2.8rem] min-[425px]:text-[3rem] min-[1024px]:text-[4.8rem] dark:text-white">Eventos do <span className="text-custom-salmon">Entre-Linhas</span></h1>
                ...
                <img style={{ width: 480, height: 320 }} src="/Eventos.svg" className="py-[1.5rem] max-[1340px]:max-w-[60rem] max-[1170px]:max-w-[55rem] max-[1100px]:max-w-[48rem] max-[1023px]:max-w-[100%] max-[1023px]:m-auto " />
